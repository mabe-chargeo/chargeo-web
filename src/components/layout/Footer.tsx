...
export function Footer() {
  return (
    <footer className="bg-[#032B60] py-16 md:py-24 border-t border-white/5 overflow-hidden relative">
      <div className="hidden md:block absolute -bottom-40 -right-40 w-96 h-96 bg-[radial-gradient(circle,rgba(0,151,178,0.3)] pointer-events-none"></div>
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-start gap-12 md:gap-16 relative z-10">
         ...
         <div className="flex flex-col sm:flex-row gap-12 md:gap-24 text-left">
            <div className="space-y-5">
               <h4 className="text-white/40 font-bold uppercase tracking-[0.2em]">Navigation</h4>
            ...
            <div className="space-y-5">
               <h4 className="text-white/40 font-bold uppercase tracking-[0.2em]">Assistance</h4>
